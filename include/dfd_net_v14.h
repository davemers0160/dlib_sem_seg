...
using net_type = dlib::loss_multiclass_log_per_pixel<
	con3<class_count, dlib::prelu<dlib::bn_con<dfd_res_33<128, 128,cbp3_blk<128,

    dlib::concat2<dtago1, dtagi1,
    dtagi1<cont2u<128, dfd_res_33<256,256,cbp3_blk<256,

    dlib::concat2<dtago2, dtagi2,
    dtagi2<cont2u<256, dfd_res_33<512,512,con2d<512,
    
    dtago2<dfd_res_33<256,256,con2d<256,
	
    dtago1<dfd_res_33<128, 128,	cbp3_blk<128, 
